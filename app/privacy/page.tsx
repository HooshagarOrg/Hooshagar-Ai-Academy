...
const sections = [
  ...
  },
  {
    id: 'rights',
    title: '۶. حقوق شما',
    body: 'شما می‌توانید درخواست مشاهده، اصلاح، صادرات یا حذف داده‌های خود را ثبت کنید. حذف از طریق پنل حساب انجام می‌شود؛ پوشش کامل همهٔ جداول/فایل‌ها به‌صورت تدریجی تکمیل می‌شود و ادعای «حذف مطلق فوری همهٔ نسخه‌ها» مطرح نیست.',
  },
  {
    id: 'retention',
  ...
  },
  {
    id: 'contact',
    title: '۸. تماس',
    body: 'برای سوالات حریم خصوصی: contact@hooshagar.ir',
  },
]
