...
-- (توابعی که قبلاً در migration‌های 120-122 رفع نشدند)

ALTER FUNCTION get_student_performance_summary(uuid, text)   SET search_path = public;
ALTER FUNCTION expire_old_activation_codes()                  SET search_path = public;
ALTER FUNCTION test_realtime_with_user(uuid)                  SET search_path = public;
ALTER FUNCTION update_notification_timestamp()                SET search_path = public;
ALTER FUNCTION promote_students_end_of_year(uuid, integer, text, numeric) SET search_path = public;
ALTER FUNCTION calculate_student_stats(uuid)                  SET search_path = public;
ALTER FUNCTION analyze_field_selection_ai(uuid)               SET search_path = public;
ALTER FUNCTION auto_apply_lottery_results()                   SET search_path = public;
ALTER FUNCTION save_to_cache(text, text, integer)             SET search_path = public;
ALTER FUNCTION get_unread_notification_count(uuid)            SET search_path = public;
ALTER FUNCTION create_in_app_notification(uuid, varchar, text, varchar, text) SET search_path = public;
ALTER FUNCTION record_daily_login(uuid)                       SET search_path = public;
ALTER FUNCTION increment_sms_count(uuid)                      SET search_path = public;
ALTER FUNCTION detect_suspicious_activity(text, integer, integer) SET search_path = public;
ALTER FUNCTION mark_report_viewed(uuid)                       SET search_path = public;
ALTER FUNCTION trigger_check_badges_on_xp()                   SET search_path = public;
ALTER FUNCTION notify_class_parents(uuid, varchar, text, varchar, text) SET search_path = public;
ALTER FUNCTION generate_pin()                                 SET search_path = public;
ALTER FUNCTION mark_notification_read(uuid)                   SET search_path = public;
ALTER FUNCTION send_notification(uuid, text, text, text, jsonb) SET search_path = public;
ALTER FUNCTION add_xp(uuid, text, integer, text, jsonb)       SET search_path = public;
ALTER FUNCTION replace_sms_variables(text, jsonb)             SET search_path = public;
ALTER FUNCTION create_bulk_notifications(uuid[], varchar, text, varchar, text) SET search_path = public;
ALTER FUNCTION log_security_event(text, uuid, jsonb, text, text, boolean, text) SET search_path = public;
ALTER FUNCTION notify_all_parents(varchar, text, varchar, text) SET search_path = public;
ALTER FUNCTION get_unread_count()                             SET search_path = public;
ALTER FUNCTION check_and_award_badge(uuid, uuid)              SET search_path = public;
ALTER FUNCTION generate_student_number(uuid)                  SET search_path = public;
ALTER FUNCTION apply_lottery_results(uuid, boolean)           SET search_path = public;
ALTER FUNCTION calculate_education_stage(integer)             SET search_path = public;
ALTER FUNCTION calculate_level(integer)                       SET search_path = public;
ALTER FUNCTION check_ai_cache(text, text)                     SET search_path = public;
ALTER FUNCTION get_data_flow_stats()                          SET search_path = public;
ALTER FUNCTION notify_new_notification()                      SET search_path = public;
ALTER FUNCTION notify_all_teachers(varchar, text, varchar, text) SET search_path = public;
ALTER FUNCTION update_daily_financial_stats()                 SET search_path = public;
ALTER FUNCTION auto_set_education_stage()                     SET search_path = public;
ALTER FUNCTION auto_update_level_trigger()                    SET search_path = public;
ALTER FUNCTION update_lottery_status()                        SET search_path = public;
ALTER FUNCTION check_plan_limit(uuid, text)                   SET search_path = public;
ALTER FUNCTION get_student_complete_history(uuid)             SET search_path = public;
ALTER FUNCTION update_exam_stats(uuid)                        SET search_path = public;
ALTER FUNCTION cleanup_expired_otps()                         SET search_path = public;
ALTER FUNCTION check_user_limit(uuid)                         SET search_path = public;
ALTER FUNCTION promote_students_batch(uuid[], text, uuid, text) SET search_path = public;
ALTER FUNCTION cleanup_old_notifications()                    SET search_path = public;
ALTER FUNCTION check_and_award_auto_badges(uuid)              SET search_path = public;
ALTER FUNCTION update_updated_at()                            SET search_path = public;
ALTER FUNCTION get_lottery_stats(uuid)                        SET search_path = public;
ALTER FUNCTION get_debtors_report(uuid, text)                 SET search_path = public;
ALTER FUNCTION is_ip_blocked(text)                            SET search_path = public;
ALTER FUNCTION generate_staff_username(text, text)            SET search_path = public;
ALTER FUNCTION increment_user_cache_hit(uuid)                 SET search_path = public;
ALTER FUNCTION generate_activation_code()                     SET search_path = public;
ALTER FUNCTION can_register_for_lottery(uuid, uuid)           SET search_path = public;
ALTER FUNCTION mark_all_read()                                SET search_path = public;
ALTER FUNCTION trigger_update_exam_stats()                    SET search_path = public;
ALTER FUNCTION increment_user_ai_count(uuid)                  SET search_path = public;
ALTER FUNCTION hash_ip(text)                                  SET search_path = public;
ALTER FUNCTION generate_parent_report(uuid)                   SET search_path = public;
ALTER FUNCTION manually_progress_student(uuid, integer, uuid, text, uuid) SET search_path = public;
ALTER FUNCTION update_updated_at_column()                     SET search_path = public;
ALTER FUNCTION test_realtime_notification(uuid)               SET search_path = public;
ALTER FUNCTION xp_for_next_level(integer)                     SET search_path = public;
ALTER FUNCTION create_notification(uuid, text, text, text, jsonb) SET search_path = public;
ALTER FUNCTION delete_old_notifications()                     SET search_path = public;
ALTER FUNCTION auto_unlock_badges()                           SET search_path = public;
ALTER FUNCTION publish_report(uuid)                           SET search_path = public;
ALTER FUNCTION auto_close_expired_exams()                     SET search_path = public;
ALTER FUNCTION cleanup_old_ai_cache()                         SET search_path = public;
ALTER FUNCTION predict_konkur_rank(uuid)                      SET search_path = public;
ALTER FUNCTION promote_students_end_of_year(uuid, integer, text, numeric) SET search_path = public;
