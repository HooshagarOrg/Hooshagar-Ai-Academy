...
- قفسه **هر مدرسه جدا** است (`school_id` + پایه). کتابخانهٔ سراسری پلتفرم ساخته نمی‌شود تا چند مدرسه و مجوز نشر مشخص شود.
...
- معلمان همان پایه همان آپلود را می‌بینند — یک‌بار کافی است.
