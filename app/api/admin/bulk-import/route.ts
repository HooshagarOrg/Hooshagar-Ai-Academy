...
زهرا,رضایی,0987654321,پنجم,پنجم ب,فاطمه,رضایی,9399654875,مادر,09399654875`,
        staff: `نام,نام_خانوادگی,کد_ملی,نقش,موبایل,کد_ورود,پایه,کلاس
حسن,کریمی,1122334455,معلم,09122222222,1122334455,4,چهارم الف
مریم,ثلبتی,3344556677,معلم,09123334455,3344556677,4,کلاس خانم ثلبتی
