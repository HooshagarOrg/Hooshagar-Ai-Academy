...
export const AVAILABLE_MODELS: AvailableModel[] = [
  // Gemini Models (FREE!)
  {
    ...
    modelDescription: 'مدل سریع و رایگان گوگل — پیش‌فرض عمومی',
    supportsText: true,
    supportsVision: true,
    supportsJson: true,
  ...
  },
  {
    ...
    modelDescription: 'مدل سبک رایگان — چت و تولید محتوا',
    supportsText: true,
    supportsVision: true,
    supportsJson: true,
    supportsFunctionCalling: true,
    ...
    isAvailable: true,
    category: 'general',
    recommendedFor: ['content_creator', 'exam_generator', 'talent_analyzer'],
    priority: 95,
  },
  {
    id: 'gemini-2.5-pro',
    ...
    modelDescription: 'مدل قدرتمند رایگان — تحلیل عمیق',
    supportsText: true,
    supportsVision: true,
    supportsJson: true,
    supportsFunctionCalling: true,
    ...
    isAvailable: true,
    category: 'general',
    recommendedFor: ['student_analyzer', 'future_compass', 'konkur_roadmap'],
    priority: 90,
  },
  // Claude Models
  {
...
export const DEFAULT_FEATURE_CONFIGS: Record<string, Partial<AIModelConfig>> = {
  ...
  ocr_solver: {
    ...
    primaryModel: 'gemini-2.5-flash',
    fallbackProvider: 'openrouter',
    fallbackModel: 'qwen/qwen2.5-vl-72b-instruct:free',
    temperature: 0.2,
    maxTokens: 1500,
  },
  study_buddy: {
  ...
  future_compass: {
    ...
    primaryModel: 'gemini-2.5-flash',
    fallbackProvider: 'openrouter',
    fallbackModel: 'x-ai/grok-4.1-fast:free',
    temperature: 0.6,
    maxTokens: 2500,
  },
}
...
export async function getAIModelConfig(featureName: string): Promise<AIModelConfig | null> {
  ...
  if (defaultConfig) {
    return {
      ...
      primaryModel: defaultConfig.primaryModel || 'gemini-2.5-flash',
