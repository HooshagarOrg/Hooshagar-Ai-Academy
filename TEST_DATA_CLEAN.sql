...
-- 📝 نکته: ابتدا UUID‌های کاربران خود را پیدا کنید:
-- SELECT id, email, role FROM profiles WHERE role IN ('teacher', 'parent', 'student');

-- ========================================
-- مرحله 1: ایجاد مدرسه و کلاس
-- ========================================
...
BEGIN
  ...
  RAISE NOTICE '✅ داده‌های تستی با موفقیت ایجاد شدند!';
